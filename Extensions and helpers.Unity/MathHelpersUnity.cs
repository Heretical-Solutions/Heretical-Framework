...
namespace HereticalSolutions
{
    public static class MathHelpersUnity
    {
        ...
        public static Vector3 AxisVector3X(
            float value)
        {
            return new Vector3(
                value,
        ...
        public static Vector3 AxisVector3Y(
            float value)
        {
            return new Vector3(
                0f,
        ...
        public static Vector3 AxisVector3Z(
            float value)
        {
            return new Vector3(
                0f,
        ...
        public static Vector2 Vector3To2XY(
            Vector3 vector)
        {
            return (Vector2)vector;
        }
        
        public static Vector2 Vector3To2XZ(
            Vector3 vector)
        {
            return new Vector2(
                vector.x,
        ...
        public static Vector3 Vector2XYTo3(
            Vector2 vector)
        {
            return (Vector3)vector;
        }
        
        public static Vector3 Vector2XZTo3(
            Vector2 vector)
        {
            return new Vector3(
                vector.x,
        ...
        public static System.Numerics.Vector2 UnityVector2ToNumericsVector2(
            Vector2 vector)
        {
        ...
        public static System.Numerics.Vector3 UnityVector3ToNumericsVector3(
            Vector3 vector)
        {
        ...
        public static Vector2 NumericsVector2ToUnityVector2(
        ...
        public static Vector3 NumericsVector3ToUnityVector3(
