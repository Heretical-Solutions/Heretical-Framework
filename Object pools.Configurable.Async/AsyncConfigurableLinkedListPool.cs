...
{
	public class AsyncConfigurableLinkedListPool<T>
		: IAsyncPool<T>,
		  IAsyncResizable,
		  ...
		  IDisposable
	{
		...
		private readonly AsyncConfigurableLinkedListPoolFactory factory;

		private int capacity;

		public AsyncConfigurableLinkedListPool(
			LinkedList<T> pool,
			IAsyncAllocationCommand<T> allocationCommand,
			AsyncConfigurableLinkedListPoolFactory factory)
		{
			this.pool = pool;
		...
		public async Task Resize(
			...
			AsyncExecutionContext asyncContext)
		{
			capacity = await factory.ResizeAsyncConfigurableLinkedListPool(
				pool,
				capacity,
				allocationCommand,
				asyncContext);
