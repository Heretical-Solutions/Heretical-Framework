...
{
	public class AsyncNonAllocPingerFactory
	{
		...
		public AsyncNonAllocPingerFactory(
		...
		public AsyncNonAllocPinger BuildAsyncNonAllocPinger()
		{
			return BuildAsyncNonAllocPinger(
				defaultSubscriptionPoolInitialAllocationDescriptor,
				defaultSubscriptionPoolAdditionalAllocationDescriptor);
		}
		...
		{
			ILogger logger =
				loggerResolver?.GetLogger<AsyncNonAllocPinger>();

			return new AsyncNonAllocPinger(
				subscriptionBag,
				contextPool,
				new object(),
				logger);
