...
namespace Mirror
{
    public class LiteNetLibTransport : Transport
    {
        ...
        public override void ClientSend(ArraySegment<byte> segment, int channelId = Channels.Reliable)
        {
            ...
            {
                //logger.LogWarning("Can't send when client is not connected");
                Debug.LogError("Can't send when client is not connected");
        ...
        public override void ServerSend(int connectionId, ArraySegment<byte> segment, int channelId = Channels.Reliable)
        {
            ...
            {
                //logger.LogWarning("Can't send when Server is not active");
                Debug.LogError("Can't send when Server is not active");
        ...
        public override void ServerDisconnect(int connectionId)
        {
            if (server == null)
            {
                //logger.LogError("Can't disconnect when Server is not active");
                Debug.LogError("Can't disconnect when Server is not active");
