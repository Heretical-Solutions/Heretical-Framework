...
namespace Mirror
{
    public struct Vector3Long
    {
        ...
        //Got this error right after importing Mirror
        //error CS0433: The type 'HashCode' exists in both 'Microsoft.Bcl.HashCode ...' and 'mscorlib ...'
        //The comment below says it should be working without defining
        //Commenting this thing out as Rider insists on including both mscorlib and Microsoft.Bcl into csproj file
        //effectively overriding it or resolve to some particular lib.namespace.class thing
        /*
