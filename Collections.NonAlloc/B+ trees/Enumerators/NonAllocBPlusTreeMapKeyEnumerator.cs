...
{
	public struct NonAllocBPlusTreeMapKeyEnumerator<TKey, TValue> : IEnumerator<TKey>
	{
		...
		public NonAllocBPlusTreeMapKeyEnumerator(NonAllocBPlusTreeMapNode<TKey, TValue> root)
		{
			this.root = root;
