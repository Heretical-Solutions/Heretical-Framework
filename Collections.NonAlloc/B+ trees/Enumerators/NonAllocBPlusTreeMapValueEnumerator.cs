...
{
	public struct NonAllocBPlusTreeMapValueEnumerator<TKey, TValue> : IEnumerator<TValue>
	{
		private readonly NonAllocBPlusTreeMapNode<TKey, TValue> root;
		private NonAllocBPlusTreeMapNode<TKey, TValue> currentNode;
		private int currentIndex;
		private bool started;

		public NonAllocBPlusTreeMapValueEnumerator(NonAllocBPlusTreeMapNode<TKey, TValue> root)
		{
			this.root = root;
